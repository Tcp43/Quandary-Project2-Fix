  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
     ...
     if (fname.equals("main")) {
        if (as.size() != 1) {
           interpreter.Interpreter.fatalError("main() expects 1 argument",
              interpreter.Interpreter.EXIT_PARSING_ERROR);
        }
        RESULT = new MainCallExpr(as.get(0), loc(fnameleft, rparright));
     } else {
